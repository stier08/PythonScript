...
BOOST_PYTHON_MODULE(Npp)
{
	...
	boost::python::class_<ScintillaWrapper, boost::shared_ptr<ScintillaWrapper>, boost::noncopyable >("Editor", boost::python::no_init)
		...
		.def("setIMEInteraction", &ScintillaWrapper::SetIMEInteraction, boost::python::args("imeInteraction"), "Choose to display the the IME in a window or inline.")
		...
		.def("setXOffset", &ScintillaWrapper::SetXOffset, boost::python::args("newOffset"), "Set the xOffset (ie, horizontal scroll position).")
		...
		.def("setSelectionNCaret", &ScintillaWrapper::SetSelectionNCaret, boost::python::args("selection", "pos"), "Set the caret position of the nth selection.")
		...
		.def("setSelectionNAnchor", &ScintillaWrapper::SetSelectionNAnchor, boost::python::args("selection", "posAnchor"), "Set the anchor position of the nth selection.")
		...
		.def("setRectangularSelectionCaret", &ScintillaWrapper::SetRectangularSelectionCaret, boost::python::args("pos"), "Set the caret position of the rectangular selection.")
		...
		.def("setRectangularSelectionAnchor", &ScintillaWrapper::SetRectangularSelectionAnchor, boost::python::args("posAnchor"), "Set the anchor position of the rectangular selection.")
